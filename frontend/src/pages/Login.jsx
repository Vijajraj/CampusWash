      ...
      <div className="w-full max-w-md bg-surface border border-border rounded-xl shadow-sm p-8 text-center animate-fade-in">
        ...
        <div className="mt-6 pt-4 border-t border-border flex justify-center">
          <a
            ...
            className="flex items-center gap-1.5 py-1.5 px-4 bg-surface border border-border hover:border-primary-lt hover:bg-bg rounded-lg text-xs font-semibold text-text shadow-sm transition-all duration-200 cursor-pointer active:scale-95"
          >
